...
public class BitwaTrojek extends Walka{
    void bitwa(Przeciwnik hero1, Przeciwnik hero2, Przeciwnik hero3){
    ...
    void losujPrzeciwnikow(Przeciwnik[] tablicaPrzeciwnikow){
        ...
        for(int j=0;j<tabelaLosujaca.length; j++){
            ...
            switch(tabelaLosujaca[j]){
                case 0: {
                    Potwor dzikiPies = new Potwor(1,1,2,3,"DzikiPies", true);
                    tablicaPrzeciwnikow[i] = dzikiPies;
                    i++;
                     break;
                }
                case 1: {
                    Potwor zablakanyPies = new Potwor(2,2,5,7,"Zablakany pies", true);
                    tablicaPrzeciwnikow[i] = zablakanyPies;
                    i++;
                    break;
                }
                case 2: {
                    Potwor dzikiWilk = new Potwor(3,3,11,10,"Dziki Wilk", true);
                    tablicaPrzeciwnikow[i] = dzikiWilk;
                    i++;
                    break;
                }
                case 3: {
                    Potwor niedzwiedz = new Potwor(2,5,20,40,"Niedzwiedz", true);
                    tablicaPrzeciwnikow[i] = niedzwiedz;
                    i++;
                    break;
                }
                case 4: {
                    Potwor boss = new Potwor(5,5,80,100,"boss", true);
